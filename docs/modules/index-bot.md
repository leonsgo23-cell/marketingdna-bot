...
| `block7_scripts.js` | 480 | Сценарии: карусели, фото, Stories, видео. Все промпты используют полный контекст: biz, aud, castdev, castdevPhrases, realNichePhrases, reviewSitePhrases, clientContext (brandVoice/monthlyGoal/monthlyFocus/clientStories/priceRange), rawContext, visionStyle, existingStyle, analyticsBlock, historyBlock, legalRules, ctaInstruction. Видео: referenceBlock (ШАГ 1-5) + ПРАВИЛА EN-ПРОМПТА с формулой ДЕЙСТВИЕ+ЭМОЦИЯ (примеры плохо/хорошо по ролям: БОЛЬ/ПОВОРОТ/ПРОЦЕСС/РЕЗУЛЬТАТ). Карусели: referenceCarouselBlock (ШАГ 1-4) + ПРАВИЛО ТЕКСТА (7 текстов = нарратив: хук→развитие→поворот→CTA) + ПРАВИЛО ИЗОБРАЖЕНИЙ (единый визуальный мир: одна палитра+настроение, прогрессия планов wide→medium→close-up→final). Фото: referencePhotoBlock (ШАГ 1-4). Stories: referenceStoriesBlock (ШАГ 1-4) + ПРАВИЛО СЕРИИ (все сторис = главы одной истории: хук→развитие→пик→CTA, нарастание) + ПРАВИЛО ВИЗУАЛА (единый визуальный мир: одна палитра+настроение, прогрессия планов wide→medium→close-up→final, ссылка "same color palette and mood as Story 1" в каждом промпте) — добавлено 28.06.2026 |
