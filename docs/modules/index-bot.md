...
Block9 (контент-план): всегда два плана по 15 дней — **Волна 1** (дни 1–15, привлечение) + **Волна 2** (дни 16–30, активация). Q9 цель клиента влияет на стратегию обоих планов. На 15-й день — аналитика Metricool, затем доставка Wave2.
