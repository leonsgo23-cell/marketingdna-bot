...
function buildFreePackJson(data, generated) {
  ...
  return {
    ...
    stripe_a_discount: process.env.STRIPE_PKG_A_DISCOUNT || process.env.STRIPE_PKG_A || '#',
    stripe_standard: process.env.STRIPE_PKG_STANDARD || '#',
    stripe_standard_discount: process.env.STRIPE_PKG_STANDARD_DISCOUNT || process.env.STRIPE_PKG_STANDARD || '#',
    stripe_v: process.env.STRIPE_PKG_V || '#',
    stripe_v_discount: process.env.STRIPE_PKG_V_DISCOUNT || process.env.STRIPE_PKG_V || '#',
