...
ОПУБЛИКОВАННЫЙ КОНТЕНТ (последние 2 недели):
${publishedContent}
...
2. Перейдите по ссылке и подключите аккаунт:
[ссылка]

Если у вас несколько платформ — мы подключим их на основе информации которую вы уже указали.

*Если не можете или не хотите переходить на бизнес-аккаунт* — это немного снизит оперативность нашей реакции на поведение вашей аудитории, но вы можете это компенсировать. Раз в две недели присылайте нам скриншоты статистики из приложения: охват за период, лучшие посты, статистику Reels. Мы сделаем анализ и учтём это при подготовке следующего контента.
