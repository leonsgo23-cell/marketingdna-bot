...
Изображение слайда 1: [промпт для AI-генерации на английском — конкретная сцена, стиль, цвета, настроение]
...
Промпт для AI-генерации: [готовый промпт на английском — формат 9:16 вертикаль, конкретная сцена, стиль, цвета, текст на обложке]
...
Промпт для AI-генерации: [готовый промпт на английском — квадрат 1:1, конкретная сцена, стиль, цвета, настроение — строго для этого бизнеса, без людей в кадре]
