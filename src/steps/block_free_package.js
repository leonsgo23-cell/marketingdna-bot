...
КАДР 1:
Текст поверх фото: [цепляющий заголовок — 3-6 слов, обложка карусели]
Промпт для изображения: [чистая фоновая сцена на английском — без текста на изображении, конкретная атмосфера, стиль, цвета]

КАДР 2:
Текст поверх фото: [1-2 предложения — суть этого слайда]
Промпт для изображения: [чистая фоновая сцена на английском — без текста на изображении]

КАДР 3:
Текст поверх фото: [1-2 предложения]
...
КАДР 7:
Текст поверх фото: [финальный текст + CTA — призыв к действию]
