...
ПРАВИЛО ХУКОВ НА СЛАЙДАХ — СТРОГО:
Хук слайда = ровно 3-6 слов. Не больше. Это короткий удар — стопкадр.
ПРИМЕРЫ ХОРОШИХ ХУКОВ (именно такого формата):
✅ "Контент без плана — убыток"
✅ "Один пост = один клиент"
✅ "Напишите нам — получите план"
✅ "Конкуренты уже это делают"
✅ "Ваш контент работает без вас"
ЗАПРЕЩЕНО писать хук длиннее 6 слов. Если хочется написать длиннее — обрежь до сути.
Подпись к слайду = 1-2 предложения, раскрывает хук, идёт под изображением как caption.
...
Фреймворк: [AIDA/PAS/BAB]
Портрет: [имя]
Хук слайда 1: [3-6 слов — стопкадр]
