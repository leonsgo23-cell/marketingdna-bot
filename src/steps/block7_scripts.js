...
Изображение слайда 1: [промпт для AI-генерации на английском — ОБЯЗАТЕЛЬНО включи текст слайда 1 как крупную жирную надпись прямо на изображении, конкретная сцена, стиль, цвета]
...
Промпт для AI-генерации: [готовый промпт на английском — 9:16, стиль, сцена, цвета, настроение — ОБЯЗАТЕЛЬНО включи текст из поля "Текст на экране" как крупную надпись прямо на изображении]
