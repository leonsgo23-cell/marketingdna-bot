...
Создай ${videoCount} технических задания (ТЗ) для генерации коротких AI B-roll видео (30 секунд каждое = 4 сцены по 8 сек).
Это видео для Reels / TikTok / Shorts бизнеса.
Пиши БЕЗ markdown-форматирования — только чистый текст.
${langInstruction}
${fieldNamesRule}

ВАЖНО — КОНТЕКСТНОСТЬ: каждая сцена должна содержать КОНКРЕТНЫЕ визуальные детали ЭТОГО бизнеса.
НЕ generic B-roll: "laptop on desk", "coffee cup", "hands typing".
ДА — специфика ниши + города + продукта: "artisan sourdough loaves on wooden shelf in small Riga bakery, morning light", "tattoo artist's gloved hands adjusting stencil on client's arm, studio lighting".
Зритель должен за 5 секунд понять: ЧТО это за бизнес и ДЛЯ КОГО.

Тип видео: B-roll (атмосфера, детали, продукт, пространство, процесс).
Человек в кадре — только руки, силуэт, спина или мелькает на фоне. НЕ лицо крупным планом, НЕ говорит в камеру.
Формат: вертикальный 9:16 (Instagram Reels / TikTok).
Стиль: фотореалистичная съёмка — как настоящая камера. Никакой анимации, рисованного стиля, цифрового арта.
...
Для каждого ТЗ используй СТРОГО этот формат:
...
СЦЕНЫ ДЛЯ ГЕНЕРАЦИИ:
СЦЕНА 1 (0-8 сек):
  EN: [English prompt: конкретная визуальная деталь этого бизнеса, vertical 9:16, photorealistic cinematic, no text, no words, no face close-ups]
  RU: [что видит зритель — 1 предложение по-русски, для проверки менеджером]
СЦЕНА 2 (8-16 сек):
  EN: [English prompt: другой ракурс или деталь того же бизнеса, vertical 9:16, photorealistic, no text]
  RU: [что видит зритель]
СЦЕНА 3 (16-24 сек):
  EN: [English prompt: атмосфера или рабочий процесс этой ниши, vertical 9:16, photorealistic, no text]
  RU: [что видит зритель]
СЦЕНА 4 (24-30 сек):
  EN: [English prompt: финал — клиент, результат или эмоциональная точка, vertical 9:16, photorealistic, no text]
  RU: [что видит зритель]
───────────────
    `, 8000);
