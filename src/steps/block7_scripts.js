...
ПРАВИЛО ТЕКСТА НА СЛАЙДАХ (критично):
Хук слайда = максимум 5-7 слов. Это законченная, самодостаточная мысль — читатель должен понять её без контекста.
НЕ обрывай мысль на полуслове. Хук должен заканчиваться как настоящее предложение.
Подпись к слайду = 1-2 предложения, раскрывает хук, идёт под изображением в посте.
От слайда к слайду мысль развивается — но каждый хук работает и сам по себе.
...
Фреймворк: [AIDA/PAS/BAB]
Портрет: [имя]
Хук слайда 1: [5-7 слов — стопкадр, законченная мысль]
Подпись к слайду 1: [1-2 предложения]
Изображение слайда 1: [промпт на английском — NO text inside image, atmospheric scene, style, colors]
Хук слайда 2: [5-7 слов — законченная мысль]
Подпись к слайду 2: [1-2 предложения]
Изображение слайда 2: [промпт на английском — NO text inside image, scene, style, colors]
Хук слайда 3: [5-7 слов — законченная мысль]
Подпись к слайду 3: [1-2 предложения]
Изображение слайда 3: [промпт на английском — NO text inside image, scene, style, colors]
Хук слайда 4: [5-7 слов — законченная мысль]
Подпись к слайду 4: [1-2 предложения]
Изображение слайда 4: [промпт на английском — NO text inside image, scene, style, colors]
Хук слайда 5: [5-7 слов — законченная мысль]
Подпись к слайду 5: [1-2 предложения]
Изображение слайда 5: [промпт на английском — NO text inside image, scene, style, colors]
Хук слайда 6: [5-7 слов — законченная мысль]
Подпись к слайду 6: [1-2 предложения]
Изображение слайда 6: [промпт на английском — NO text inside image, scene, style, colors]
Хук слайда 7 (CTA): [5-7 слов — призыв к действию]
Подпись к слайду 7: [1-2 предложения + CTA]
Изображение слайда 7: [промпт на английском — NO text inside image, scene, style, colors]
